...
public interface BookControllerDocs {
    ...
    @Operation(summary = "Find Book by Author",
            description = "Finds Book by their Author",
            tags = {"Books"},
            responses = {
                    @ApiResponse(
                            description = "Success",
    ...
    @Operation(summary = "Find Book by Title",
            description = "Finds Book by their Title",
            tags = {"Books"},
            responses = {
                    @ApiResponse(
                            description = "Success",
    ...
    @Operation (
            ...
            description = "Upadate a Specific Book your Id",
            tags = {"Book"},
            responses = {
                    @ApiResponse (
                            description = "Success",
    ...
    @Operation (
            ...
            description = "Delete a Specific Book Your Id",
            tags = {"Book"},
            responses = {
                    @ApiResponse (
                            description = "Success",
